          ...
          {token ? (
            <Menu as="div" className="relative ml-3">
              <div className="flex items-center gap-3">
                {userInfo && (
                  <span className="text-pink-700 font-medium">{userInfo.firstname}</span>
                )}
              ...
              <MenuItems className="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-2 shadow-lg ring-1 ring-pink-200 focus:outline-none">
                <MenuItem>
                  <a href="#" className="block px-4 py-2 text-sm text-pink-700 hover:bg-pink-100">Your Profile</a>
                </MenuItem>
                <MenuItem>
                  <a href="#" className="block px-4 py-2 text-sm text-pink-700 hover:bg-pink-100">Settings</a>
                </MenuItem>
                <MenuItem>
                  <a onClick={handleLogOut} href="#" className="block px-4 py-2 text-sm text-pink-700 hover:bg-pink-100">Log out</a>
                </MenuItem>
              </MenuItems>
            </Menu>
          ) : (
